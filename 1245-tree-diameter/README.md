<h2><a href="https://leetcode.com/problems/tree-diameter">1245. Tree Diameter</a></h2><h3>Medium</h3><hr><p>The <strong>diameter</strong> of a tree is <strong>the number of edges</strong> in the longest path in that tree.</p>
